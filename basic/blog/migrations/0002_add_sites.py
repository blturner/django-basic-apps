...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'blog.post': {
            ...
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['blog.Category']", 'blank': 'True'}),
